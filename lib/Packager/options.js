...
module.exports = {
	...
	clean: {
		help: 'Only used with --cache. This will force a complete rebuild of the target but ' +
			'will cache the result for subsequent runs. If --cache is enabled but no cache file ' +
			'exists, it is the same as using this option. If this flag is set but the --targets ' +
	...
	build: {
		help: 'A comma-separated list of bundles to (re)build. If --cache is enabled and includes ' +
